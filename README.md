...
A tiny and fast (463b <sup>[unpkg](https://unpkg.com/stable-hash@0.0.2/dist/index.mjs)</sup>) lib for "stably hashing" a JavaScript value. Originally created for [SWR](https://github.com/vercel/swr).
